...
## Обо мне
Магистр по астрофизике с сильным бэкграундом в математике и физике. Применяю эти знания в задачах анализа данных и машинного обучения. Имею практический опыт работы с Python, включая обработку данных и построение моделей. Быстро осваиваю новые инструменты и алгоритмы, ответственно подхожу к решению задач и мотивирован далее развиваться в выбранной области.

*Область интересов*: Рекомендательные системы, анализ данных.

---

## Навыки
- **Навыки:** Python, SQL, MongoDB 
- **Библиотеки:** Pandas, Matplotlib, SciPy, Scikit-learn, CatBoost, PyTorch  
- **Инструменты:** Jupyter Notebook, Docker, Git, Linux (удалённые серверы)  
...
### Рекомендательная система фильмов и сериалов.
Разработка рекомендательной системы фильмов и сериалов. **Стек:**: MongoDB, Pandas, Matplotlib, cornac, lightfm.
...
## Опыт работы
**Международное интернет-телевидение Novoe-TV**
*Младший разработчик рекомендательных систем*
